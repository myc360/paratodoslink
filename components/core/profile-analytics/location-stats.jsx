  ...
  return (
    <>
      <div className="mt-10 w-full">
        <h3 className="text-xl font-semibold">Principais locais</h3>
        <div className="rounded-xl mt-4 border bg-white h-auto p-4">
          <div className="">
            <h3 className="font-semibold text-md px-3 pb-1">Visitantes</h3>
            <p className="text-gray-500 text-sm px-3 mb-2">
              Rastreie os visitantes da sua página por país
            </p>
          </div>
          <div className="w-full h-auto">
            {displayedCountries?.length > 0 ? (
              ...
              <div className="my-6 flex justify-center">
                <h3 className="text-center">Não há dados disponíveis</h3>
              </div>
            )}
