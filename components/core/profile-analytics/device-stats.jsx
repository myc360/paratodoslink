  ...
  return (
    <div className="mt-10 w-full">
      ...
      <div className="rounded-xl border bg-white p-4">
        <div className="mb-4">
          <h3 className="font-semibold text-md px-3 pb-1">Dispositivos</h3>
          <p className="text-gray-500 text-sm px-3">
            Insights sobre os dispositivos que seu público usa
          </p>
        </div>
        <div
        ...
        <div className="mx-auto mt-6 w-full md:w-[300px] lg:w-[400px]">
          {analytics?.length > 0 ? (
            ...
            <div className="my-6 flex justify-center">
              <h3 className="text-center">Não existe dados dispóniveis</h3>
            </div>
          )}
        </div>
      </div>
