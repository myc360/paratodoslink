...
export const metadata = {
  title: 'Paratodos.link',
  description:
    'Paratodos.link é um link na bio aberto a todos para ajudar você gerenciar facilmente seus links, transformando sua presença online.',
};
...
const Home = () => {
  ...
  return (
    <>
      <Head>
        <title>Paratodos.link | Um link para todos.</title>
        {/* <!-- Open Graph (OG) meta tags --> */}
        <meta property="og:url" content="https://paratodos.link/" />
        <meta property="og:url" content="https://paratodos.link/" />
        <meta property="og:url" content="https://www.paratodos.link" />
        <meta property="og:type" content="website" />
        <meta
          property="og:site_name"
          content="Paratodos.link - Um link na bio feito PARATODOS!"
        />
        <meta property="og:title" content="Paratodos.link" />
        <meta
          property="og:description"
          content="Paratodos.link é um link na bio aberto a todos para ajudar você gerenciar facilmente seus links, transformando sua presença online."
        />
        <meta
          property="og:image"
          itemprop="image"
            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6">
              ...
              >
                <Link
                  ...
                  href="/"
                >
                  <h3 className="lg:block">Paratodos.link</h3>
                </Link>
            ...
            <div className="px-4 mx-auto mt-24 max-w-7xl sm:mt-16 sm:px-6">
              <div className="text-center">
                <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                  <span className="block">Um link na bio feito </span>
                  <span className="hero-title block ">PARATODOS</span>
                </h1>
                <p className="max-w-md mx-auto mt-3 text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                  Paratodos.link é um link na bio aberto a todos para ajudar você
                  gerenciar facilmente seus links, transformando sua presença online.
                </p>
              </div>
          ...
          <div className="px-4 py-16 mx-auto max-w-7xl sm:py-24 sm:px-6 lg:px-8">
            <h2 className="text-lg font-semibold tracking-wide text-center text-gray-400">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                href="https://myc360.ag/myc360.ag"
              >
                @myc360.ag
              </a>
            </h2>
            <div className="flex items-center gap-4 justify-center mt-4">
              <a
                href="https://x.com/paratodos.link"
                target="_blank"
                rel="noopener noreferrer"
